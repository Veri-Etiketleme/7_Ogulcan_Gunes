...
all_data = False                                 # use all data in once for evaluation
pretrain_path = "/media/data/ebron/results/7093_GM_f4_AD_allCNN/" # path to pre-trained AD model
mean_file = "/media/data/ebron/results/7093_GM_f4_AD_allCNN/k0/mean.npy"            # path to mean of AD training data for normalisation 
std_file = "/media/data/ebron/results/7093_GM_f4_AD_allCNN/k0/std.npy"              # path to std of AD training data for normalisation 
