...
pretrain_path = "/media/data/ebron/results/8955_T1_AD_allCNN/" # path to pre-trained AD model
mean_file = "/media/data/ebron/results/8955_T1_WB_AD_allCNN/k0/mean.npy"            # path to mean of AD training data for normalisation 
std_file = "/media/data/ebron/results/8955_T1_WB_AD_allCNN/k0/std.npy"              # path to std of AD training data for normalisation 
...
if location == "local":
    ...
    data_dir = f"/media/data/ebron/bigr_mount/tmichelotti/data_ADNI_{roi}/"
    ...
    if parelsnoer:
        subjectfile = "/media/data/jlinders/parelsnoer/labels/Parelsnoer_AllSubjectsBaselineDiagnosis.csv"
