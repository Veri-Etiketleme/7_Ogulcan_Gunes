...
#import visualization.vis_config import roi, task, label, data_set, val, server, temp, class_limit, analysis
...
def split_classes(subjectfile, set_file, class0, class1):
    ...
    """
    # get test subjects
    subs = np.load(set_file, allow_pickle=True).item()[data_set][0]
