...
import pydotplus
        ...
        #def AttritionPredictor():
def AttritionPredictor(satisfaction,
                        evaluation,
                        number_of_projects,
                        ...
                        department):
        # Read Data
        data = pd.read_csv("/Users/p5102818/OneDrive - Ness Technologies/Workspace/Employee_Attrition_Prediction/mysite/polls/AttritionModel/Data/data.csv")
        ...
        plt.axis('equal')
        plt.savefig('/Users/p5102818/OneDrive - Ness Technologies/Workspace/Employee_Attrition_Prediction/mysite/polls/AttritionModel/output/attrition_rate.png')
        ...
        graph.write_pdf("/Users/p5102818/OneDrive - Ness Technologies/Workspace/Employee_Attrition_Prediction/mysite/polls/AttritionModel/output/DecisionTreeGraph.pdf")

        # Now it's time to Predict
        input_data = pd.read_csv("/Users/p5102818/OneDrive - Ness Technologies/Workspace/Employee_Attrition_Prediction/mysite/polls/AttritionModel/Data/input.csv")
        #input_data = input_data.drop()
        input_data['satisfaction'] = satisfaction
        input_data['evaluation'] = evaluation
        input_data['number_of_projects'] = number_of_projects
...
print("Calling Attrition Model")
AttritionPredictor(satisfaction=1,
                        evaluation=2,
